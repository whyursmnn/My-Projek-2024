<div class="container mx-auto p-4">
    <a href="{{ route('teacher.courses.create') }}"
        class="inline-block bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Tambah Course</a>
    ...
    <div class="mt-6">
        <table class="table-auto w-full border border-gray-300">
            ...
            <tbody>
                @php
                    $courses = $courses ?? collect(); // Pastikan $courses tidak null
                @endphp
                    ...
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="px-4 py-2 border border-gray-300">
                            ...
                            <form action="{{ route('teacher.courses.destroy', $course->id) }}" method="POST"
                                class="inline" onsubmit="return confirm('Yakin ingin menghapus course ini?')">
                                @csrf
                                @method('DELETE')
                ...
                @empty
                    <tr>
                        <td colspan="8" class="text-center px-4 py-2 border border-gray-300">Tidak ada course yang
                            tersedia.</td>
                    </tr>
                @endforelse
            </tbody>
